...
topright_div.addEventListener("mouseleave", function() {
    topright_div.style.backgroundColor = "white";
    if (topright_text.parentNode) {//yo if narakhera garda like 1choti ma kaam garxa but 2nd time mouse lyauda chai kaam gardaina
...
bottomright_div.addEventListener("mouseleave", function() {
    ...
    if (bottomright_text.parentNode) {
        bottomright_div.removeChild(bottomright_text); // hide text
    }
});